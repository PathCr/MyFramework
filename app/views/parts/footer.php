        ...
        <div class="container">
            <div class="row">
                <div class="col-md-3 col-6">
                    <h4><?php get_Phrase('parts_footer_col-md-1');?></h4>
                    <ul class="list-unstyled">
                        <li><a href="#"><?php get_Phrase('parts_footer_main');?></a></li>
                        <li><a href="#"><?php get_Phrase('parts_footer_about-the-store');?></a></li>
                        <li><a href="#"><?php get_Phrase('parts_footer_payment-and-delivery');?></a></li>
                        <li><a href="#"><?php get_Phrase('parts_footer_contacts');?></a></li>
                    </ul>
                </div>

                <div class="col-md-3 col-6">
                    <h4><?php get_Phrase('parts_footer_col-md-2');?></h4>
                    <ul class="list-unstyled">
                        <li>г. Краснодар</li>
                ...
                <div class="col-md-3 col-6">
                    <h4><?php get_Phrase('parts_footer_col-md-3');?></h4>
                    <ul class="list-unstyled">
                ...
                <div class="col-md-3 col-6">
                    <h4><?php get_Phrase('parts_footer_col-md-4');?></h4>
                    <div class="footer-icons">
                        <a href="#"><i class="fab fa-facebook-f"></i></a>
                        <a href="https://vk.com/kidseq"><i class="fab fa-vk"></i></a>
