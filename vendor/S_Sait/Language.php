...
class Language
{
    ...
    // массив со всеми переводными фразами которые относятся к шаблону
    public static array $lang_layout = [];

    // массив со всеми переводными фразами представления (вида)
    public static array $lang_view = [];

    public static function load($code, $view) // view - маршрут
    {
